package com.java.chenguo.ForGesture2;
...
public class ChannelActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.java.chenguo.R.layout.channel2);

        //获取username
        Intent intent = getIntent();
        username = intent.getStringExtra("username");

        channelView = findViewById(com.java.chenguo.R.id.channel_view_2);
